...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ResetPasswordValidateResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/authors/{authorId}/blogs/slug/{slug}": {
            "get": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ProcessWebhookRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.CreatePaymentRequest": {
            ...
            "properties": {
                ...
                "gateway": {
                    "$ref": "#/definitions/entity.TransactionGateway"
                },
                "planId": {
                ...
                "targetId": {
                    "description": "ID of Subscription Author or Series",
                    "type": "string"
                },
                "type": {
        ...
        "dto.ResetPasswordValidateResponse": {
            "type": "object",
            "properties": {
                "valid": {
                    "type": "boolean"
        ...
        "entity.TransactionGateway": {
            ...
            "x-enum-varnames": [
                "TransactionGatewayVietQR",
                "TransactionGatewayBankTransfer"
            ]
        },
