...
// Source: notification_aggregator.go
//
// Generated by this command:
//
//	mockgen -source=notification_aggregator.go -destination=mocks/mock_notification_aggregator.go -package=mocks
//
...
func (m *MockFirebaseAdapter) SendPush(ctx context.Context, deviceToken, title, body string, data map[string]any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendPush", ctx, deviceToken, title, body, data)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendPush indicates an expected call of SendPush.
func (mr *MockFirebaseAdapterMockRecorder) SendPush(ctx, deviceToken, title, body, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendPush", reflect.TypeOf((*MockFirebaseAdapter)(nil).SendPush), ctx, deviceToken, title, body, data)
}
